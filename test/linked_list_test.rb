...
describe LinkedList do
    ...
    describe "insert_ascending" do
        it "can insert into an empty linked list" do
        ...
        it "will insert into it's correct position for a single item list in which the existing value is larger" do
            @list.add_first(7)
            @list.insert_ascending(1)
            
            expect(@list.get_first).must_equal 1
            expect(@list.get_last).must_equal 7
        end
        
        it "will insert into it's correct position for a single item list in which the existing value is smaller" do
            @list.add_first(1)
            @list.insert_ascending(7)
        ...
        it "will insert into it's correct position for base case" do
            @list.add_first(4)
            @list.add_first(2)
            @list.add_first(1)
            @list.insert_ascending(3)
            
            expect(@list.find_nth_from_end(0)).must_equal 4
            expect(@list.find_nth_from_end(1)).must_equal 3
            expect(@list.find_nth_from_end(2)).must_equal 2
            expect(@list.find_nth_from_end(3)).must_equal 1
        end
    end
end
